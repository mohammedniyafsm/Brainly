...
export const Login=()=>{
    return(
     <div className="w-screen h-screen bg-gray-100 flex items-center justify-center">
        <div className="h-80 w-[350px] shadow-sm rounded-xl bg-white py-6">
            <div className="grid auto-rows-min grid-rows-[auto_auto] px-6 items-start gap-2">
                <div className="font-semibold font-inter leading-none ">Login</div>
            ...
            <div className="flex justify-between px-6 py-4 items-center">
                <div className="">
                    <button className="flex justify-center rounded-xl shadow-sm bg-white border border-gray-200 hover:bg-gray-100 px-4 py-1 cursor-pointer">Login</button>
                </div>
                <div className="">
                    <button className="flex justify-center rounded-xl shadow-sm bg-black text-white border border-gray-200 hover:bg-gray-900 px-4 py-1.5 cursor-pointer">Register</button>
                </div>
            </div>
        </div>
    </div>
